...
function riderRequestInfo(start_loc, end_loc, contact, passenger, status_id, eta_id) { /////INFO TO PASS ON TO ADMIN
  ...
  var data = {
    "num_passenger": radio_count,
    "start_loca_lat": startLocationLat,
    "start_loca_lng": startLocationLong,
    "end_loca_lat": endLocationLat,
    "end_loca_lng": endLocationLong,
    "phone_number": phoneNumber,
    "start_address": startAddress,
    "end_address": endAddress,
    "message_id": message_id,
    "time_arrival_datetime": time_arrival
  };
